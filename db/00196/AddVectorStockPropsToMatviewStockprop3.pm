...
=head1 NAME
 ...
 AddVectorStockPropsToMatviewStockprop3

=head1 SYNOPSIS

mx-run AddVectorStockPropsToMatviewStockprop3 [options] -H hostname -D dbname -u username [-F]
...
This patch fixes missing 'PlantAntibioticResistantMarker' and 'BacterialResistantMarker' stock properties in the MakeRankNumberStockPropViews dbpatch (00167)
...
package AddVectorStockPropsToMatviewStockprop3;
...
sub patch {
    ...
    # Now re-generate the materialized view (code lifted from AddVectorStockPropsToMatviewStockprop2 and MakeRankNumberStockPropViews)
