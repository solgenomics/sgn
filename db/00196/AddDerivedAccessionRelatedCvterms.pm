...
AddDerivedAccessionRelatedCvterms

=head1 SYNOPSIS

mx-run AddDerivedAccessionRelatedCvterms [options] -H hostname -D dbname -u username [-F]
...
package AddDerivedAccessionRelatedCvterms;
