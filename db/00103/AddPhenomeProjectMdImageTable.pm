...
sub patch {
    ...
    my $terms = {
        'project_md_image' => [
            ...
            'calculate_fourier_transform_hpf30_bgr_calculate_tgi_temporary_drone_imagery_channel_1',
            'calculate_fourier_transform_hpf30_bgr_calculate_vari_temporary_drone_imagery_channel_1',
            'calculate_fourier_transform_hpf30_nrn_calculate_ndvi_temporary_drone_imagery_channel_1',
            'calculate_fourier_transform_hpf30_nren_calculate_ndre_temporary_drone_imagery_channel_1',
