...
sub patch {
    ...
    my $terms = {
        'project_md_image' => [
            ...
            'calculate_fourier_transform_hpf30_rgb_denoised_stitched_image_channel_1',
            'calculate_fourier_transform_hpf30_rgb_denoised_stitched_image_channel_2',
            'calculate_fourier_transform_hpf30_rgb_denoised_stitched_image_channel_3',
