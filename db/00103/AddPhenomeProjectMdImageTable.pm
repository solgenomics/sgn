...
sub patch {
    ...
    my $terms = {
        'project_md_image' => [
            ...
            'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_1',
            'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_2',
            'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_3',
            'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_1',
            'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_2',
            'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_3',
            ...
            'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_1',
            'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_2',
            'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_3',
            'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_1',
            'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_2',
            'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_3',
            ...
            'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_background_threshold_removed_image_channel_1',
            'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_background_threshold_removed_image_channel_2',
            'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_background_threshold_removed_image_channel_3',
            'observation_unit_polygon_fourier_transform_hpf30_nren_denoised_background_threshold_removed_image_channel_1',
            'observation_unit_polygon_fourier_transform_hpf30_nren_denoised_background_threshold_removed_image_channel_2',
            'observation_unit_polygon_fourier_transform_hpf30_nren_denoised_background_threshold_removed_image_channel_3',
            'observation_unit_polygon_fourier_transform_hpf30_blue_denoised_background_threshold_removed_image_channel_1',
            'observation_unit_polygon_fourier_transform_hpf30_bw_denoised_background_threshold_removed_image_channel_1',
            ...
            'observation_unit_polygon_fourier_transform_hpf30_rededge_denoised_background_threshold_removed_image_channel_1',
            ...
            'observation_unit_polygon_fourier_transform_hpf30_tir_denoised_background_threshold_removed_image_channel_1',
            ...
            'denoised_background_removed_tgi_mask_original_channel_1',
            'denoised_background_removed_tgi_mask_original_channel_2',
            'denoised_background_removed_tgi_mask_original_channel_3',
            'denoised_background_removed_vari_mask_original',
            'denoised_background_removed_vari_mask_original_channel_1',
            'denoised_background_removed_vari_mask_original_channel_2',
            'denoised_background_removed_vari_mask_original_channel_3',
            'denoised_background_removed_ndvi_mask_original',
            'denoised_background_removed_ndvi_mask_original_channel_1',
            'denoised_background_removed_ndvi_mask_original_channel_2',
            'denoised_background_removed_ndvi_mask_original_channel_3',
            'denoised_background_removed_ndre_mask_original',
            'denoised_background_removed_ndre_mask_original_channel_1',
            'denoised_background_removed_ndre_mask_original_channel_2',
            'denoised_background_removed_ndre_mask_original_channel_3',
            'denoised_background_removed_thresholded_tgi_mask_original',
            'denoised_background_removed_thresholded_tgi_mask_original_channel_1',
            'denoised_background_removed_thresholded_tgi_mask_original_channel_2',
            'denoised_background_removed_thresholded_tgi_mask_original_channel_3',
            'denoised_background_removed_thresholded_vari_mask_original',
            'denoised_background_removed_thresholded_vari_mask_original_channel_1',
            'denoised_background_removed_thresholded_vari_mask_original_channel_2',
            'denoised_background_removed_thresholded_vari_mask_original_channel_3',
            'denoised_background_removed_thresholded_ndvi_mask_original',
            'denoised_background_removed_thresholded_ndvi_mask_original_channel_1',
            'denoised_background_removed_thresholded_ndvi_mask_original_channel_2',
            'denoised_background_removed_thresholded_ndvi_mask_original_channel_3',
            'denoised_background_removed_thresholded_ndre_mask_original',
            'denoised_background_removed_thresholded_ndre_mask_original_channel_1',
            'denoised_background_removed_thresholded_ndre_mask_original_channel_2',
            'denoised_background_removed_thresholded_ndre_mask_original_channel_3',
