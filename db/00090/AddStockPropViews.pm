...
AS (stock_id int,
    ...
    location_code text,
    organization text,
    plant_index_number text,
    subplot_index_number text,
    tissue_sample_index_number text,
    plot_number text,
    plot_geo_json text,
    range text,
    replicate text,
    ...
    PUI text,
    donor text,
    donor_institute text,
    donor_PUI text,
    seed_source text,
    institute_code text,
    institute_name text,
    biological_status_of_accession_code text,
    country_of_origin text,
    type_of_germplasm_storage_code text,
    entry_number text,
    acquisition_date text,
    current_count text,
    crossing_metadata_json text,
    ploidy_level text,
    genome_structure text,
    introgression_parent text,
    introgression_backcross_parent text,
    introgression_map_version text,
    introgression_chromosome text,
