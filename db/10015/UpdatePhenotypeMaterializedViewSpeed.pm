...
UpdatePhenotypeMaterializedViewSpeed.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeMaterializedViewSpeed [options] -H hostname -D dbname -u username [-F]
...
package UpdatePhenotypeMaterializedViewSpeed;
