...
=head1 NAME
 ...
 AddVectorStockPropsToMatviewStockprop.pm

=head1 SYNOPSIS

mx-run AddVectorStockPropsToMatviewStockprop.pm [options] -H hostname -D dbname -u username [-F]
...
package AddVectorStockPropsToMatviewStockprop;
