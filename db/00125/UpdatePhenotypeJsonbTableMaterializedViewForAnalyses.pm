...
UpdatePhenotypeJsonbTableMaterializedViewForAnalyses.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeJsonbTableMaterializedViewForAnalyses [options] -H hostname -D dbname -u username [-F]
...
package UpdatePhenotypeJsonbTableMaterializedViewForAnalyses;
