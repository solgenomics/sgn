...
=head1 NAME
 ...
 FixGenotypeStorageDosage

=head1 SYNOPSIS

mx-run FixGenotypeStorageDosage [options] -H hostname -D dbname -u username [-F]

this is a subclass of L<CXGN::Metadata::Dbpatch>
see the perldoc of parent class for more details.

=head1 DESCRIPTION
This patch fixes the genotype storage error of loading DS=0 when the GT is infact unknown (e.g. GT='./.'). DS is now stored as 'NA' in these cases.
...
package FixGenotypeStorageDosage;
...
sub patch {
    ...
    my $q = "SELECT nd_protocol_id FROM nd_protocol JOIN nd_protocolprop USING(nd_protocol_id) WHERE nd_protocol.type_id=$geno_cvterm_id ORDER BY nd_protocol_id ASC;";
