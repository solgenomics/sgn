...
UpdatePhenotypeMaterializedViewGenotypingProjects.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeMaterializedViewGenotypingProjects [options] -H hostname -D dbname -u username [-F]
...
package UpdatePhenotypeMaterializedViewGenotypingProjects;
