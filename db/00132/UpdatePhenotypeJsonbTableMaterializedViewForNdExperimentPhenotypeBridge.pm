...
UpdatePhenotypeJsonbTableMaterializedViewForNdExperimentPhenotypeBridge.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeJsonbTableMaterializedViewForNdExperimentPhenotypeBridge [options] -H hostname -D dbname -u username [-F]
...
This patch fixes materialized_phenotype_jsonb_table view for new nd_experiment_phenotype_bridge table
...
package UpdatePhenotypeJsonbTableMaterializedViewForNdExperimentPhenotypeBridge;
