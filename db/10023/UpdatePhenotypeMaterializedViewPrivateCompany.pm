...
UpdatePhenotypeMaterializedViewPrivateCompany.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeMaterializedViewPrivateCompany [options] -H hostname -D dbname -u username [-F]
...
package UpdatePhenotypeMaterializedViewPrivateCompany;
