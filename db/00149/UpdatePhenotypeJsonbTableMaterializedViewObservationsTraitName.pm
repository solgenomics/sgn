...
UpdatePhenotypeJsonbTableMaterializedViewObservationsTraitName.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeJsonbTableMaterializedViewObservationsTraitName [options] -H hostname -D dbname -u username [-F]
...
This patch changes observations trait_name to cvterm name in materialized_phenotype_jsonb_table view
...
package UpdatePhenotypeJsonbTableMaterializedViewObservationsTraitName;
