...
AddMissingSeedlotViews.pm

=head1 SYNOPSIS

mx-run AddMissingSeedlotViews [options] -H hostname -D dbname -u username [-F]
...
This patch:
 - adds the seedlots and locationsXseedlots views

=head1 AUTHOR

Bryan Ellerbrock - original matviews and views
David Waring <djw64@cornell.edu> - missing seedlot views
...
package AddMissingSeedlotViews;
...
This patch adds the missing seedlots and locationsXseedlots views
...
/* ======= Included in the AddGenotypeProjectViews DB Patch =========
...
-- Add missing locationsXseedlots
