...
UpdatePhenotypeJsonbTableMaterializedViewWithCollectDateAndOperator.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeJsonbTableMaterializedViewWithCollectDateAndOperator [options] -H hostname -D dbname -u username [-F]
...
package UpdatePhenotypeJsonbTableMaterializedViewWithCollectDateAndOperator;
