...
UpdateMaterializedPhenoviewSubplots.pm

=head1 SYNOPSIS

mx-run UpdateMaterializedPhenoviewSubplots [options] -H hostname -D dbname -u username [-F]
...
This patch:
 - updates the materialized_phenoview by adding subplots to the view
...
package UpdateMaterializedPhenoviewSubplots;
...
This patch updates the materialized_phenoview by adding subplots to the view
