...
mx-run UpdateWizardMaterializedViewsForGenoProtocols [options] -H hostname -D dbname -u username [-F]
...
This patch updates the materialized views for mixed stock genotyping
...
package UpdateWizardMaterializedViewsForGenoProtocols;
