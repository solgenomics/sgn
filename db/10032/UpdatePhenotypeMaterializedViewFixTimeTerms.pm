...
UpdatePhenotypeMaterializedViewFixTimeTerms.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeMaterializedViewFixTimeTerms [options] -H hostname -D dbname -u username [-F]
...
This patch fixes materialized_phenotype_jsonb_table view to include company private
...
package UpdatePhenotypeMaterializedViewFixTimeTerms;
