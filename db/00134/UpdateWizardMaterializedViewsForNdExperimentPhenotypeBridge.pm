...
mx-run UpdateWizardMaterializedViewsForNdExperimentPhenotypeBridge [options] -H hostname -D dbname -u username [-F]
...
This patch updates the materialized views for new nd_experiment_phenotype_bridge
...
package UpdateWizardMaterializedViewsForNdExperimentPhenotypeBridge;
