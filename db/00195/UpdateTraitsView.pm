...
mx-run UpdateTraitsView [options] -H hostname -D dbname -u username [-F]
...
This patch:
 find the correct variable_of relationship for the trait_ids in the public.traits.view
