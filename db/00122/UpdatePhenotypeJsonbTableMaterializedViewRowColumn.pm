...
UpdatePhenotypeJsonbTableMaterializedViewRowColumn.pm

=head1 SYNOPSIS

mx-run UpdatePhenotypeJsonbTableMaterializedViewRowColumn [options] -H hostname -D dbname -u username [-F]
...
This patch fixed the row and column info in the materialized_phenotype_jsonb_table view
...
package UpdatePhenotypeJsonbTableMaterializedViewRowColumn;
