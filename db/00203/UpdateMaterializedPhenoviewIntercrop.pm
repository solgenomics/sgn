...
UpdateMaterializedPhenoviewIntercrop.pm

=head1 SYNOPSIS

mx-run UpdateMaterializedPhenoviewIntercrop [options] -H hostname -D dbname -u username [-F]
...
This patch updates the materialized_phenoview by adding intercrop accessions to the view
...
-- use definition from FixTissueSampleSearch.pm
-- add intercropping support
