...
mx-run AddUniqueBarcodeSeq [options] -H hostname -D dbname -u username [-F]
...
Adds a sequence to the phenome schema to keep track of the unique barcode label feature.
