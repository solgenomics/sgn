...
UpdateStockPropViewsUsePublic.pm

=head1 SYNOPSIS

mx-run UpdateStockPropViewsUsePublic [options] -H hostname -D dbname -u username [-F]
...
This patch updates the materialized view for all stockprops by using public.stockprop instead of just stockprop. 
...
package UpdateStockPropViewsUsePublic;
