...
Just as with phenotype uploads, you can supply a spreadsheet specifying the stocks and the treatments with optional timestamps. To ensure the column headers are correct, consult the [treatment search page](#managing-observation-variables) or the ontology browser. 
