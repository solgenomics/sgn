---
title: "3.8 Using Field Book App"
layout: doc_page
---
...
3.8.1 Creating Field Layout Files for the Field Book App {#creating-layout-files}
--------------------------------------------------------
...
### 3.8.1.1 Creating “Field Layout Files” by using “Field Book Tools” page.
...
### 3.8.1.2 Creating “Field Layout Files” by using “Trial Detail” page.
...
3.8.2 Creating Trait Files for the Field Book App {#creating-trait-files}
-------------------------------------------------

Steps to Create a Trait File:

### 3.8.2.1 Creating a Trait List
...
3.8.3 Transferring Files from Your Computer to Android Tablet
-------------------------------------------------------------
...
3.8.4 Setting up “Field Book App” for data collection
-----------------------------------------------------
...
3.8.5 Exporting Files from Field Book App
-----------------------------------------
...
3.8.6 Uploading Phenotype Files to an SGN database {#uploading-pheno-files}
----------------------------------------------
