...
gwasresults_prnt <- gwasresults[,2:4]

gwasresults_prntsorted <- gwasresults_prnt[order(gwasresults_prnt$chr, gwasresults_prnt$loc),]  


write.csv(gwasresults_prntsorted, pval_output_filepath, row.names = FALSE, quote = FALSE)
