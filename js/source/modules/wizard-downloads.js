  ...
  wizard.on_change((c,s,o)=>{
    ...
    main.selectAll(".wizard-download-phenotypes")
      ...
      .on("click",()=>{
        ...
        var use_synonyms = d3.select(".wizard-download-phenotypes-use-synonyms").property('checked')?1:0;
        ...
        `&timestamp=${timestamp}&entry_numbers=${entry_numbers}&use_synonyms=${use_synonyms}&trait_contains=${names}`+
