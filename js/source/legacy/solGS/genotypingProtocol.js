...
solGS.genotypingProtocol= {
	...
	jQuery.ajax({
		...
		var divPlace;
		solGS.genotypingProtocol.setGenotypingProtocol(divPlace, res.default_protocol);	
...
jQuery(document).ready( function() { 
    ...
    var divPlace = '';
    jQuery("<option>", {value: '', selected: true}).prependTo(divPlace + ' #genotyping_protocol #genotyping_protocols_list_select');
   
    jQuery(divPlace +' #genotyping_protocol #genotyping_protocols_list_select').change( function() {
