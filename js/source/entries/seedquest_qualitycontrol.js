...
export function init(main_div) {
    ...
    $('#qc_analysis_prepare_button').click(function () {
        ...
        if (dataset_id != false) {
            $.ajax({
                url: '/ajax/seedquest/qualitycontrol/prepare',
    ...
    $('#selected_variable').on('change', function () {
        ...
        $.ajax({
            url: '/ajax/seedquest/qualitycontrol/grabdata',
    ...
    $('#restore_outliers_button').click(function () {
        $.ajax({
            url: '/ajax/seedquest/qualitycontrol/datarestore',
            data: { 'file': tempfile, 'trait': trait_selected },
            success: function (r) {
                $('#working_modal').modal("hide");
                if (r.message) {
                    ...
                    $.ajax({
                        url: '/ajax/seedquest/qualitycontrol/restoreoutliers',
                        method: "POST",
