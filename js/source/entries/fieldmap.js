    ...
    class FieldMap {
        ...
        field_view() {
            ...
            for (var i=0; i<plot_names.length; i++){
                ...
                result.push({plotname:plot_names[i], plot_id:plot_ids[i], stock:accession_names[i], plotn:plot_mums[i], blkn:blocks[i], rep:replicates[i], row:rows[i], plot_image_ids:plotImageDbIds[i], col:cols[i], plot_msg:plot_popUp, seedlot:seedlot_names[i]});
            }
