...
//     },
	...
	new Ajax.Request('evidence_browser.pl', {parameters: ///move this to /ajax/cvterm/relationships
		{type: type}, 
		    onSuccess: function(response) {
		    //var json = response.responseText;
		    //var x =eval ("("+json+")");
	...
	new Ajax.Request('evidence_browser.pl', { ///move to /ajax/cvterm/evidence_code
		parameters: 
		{type: type}, 
		    onSuccess: function (response) {
	...
	new Ajax.Request('evidence_browser.pl', { ///move to /ajax/cvterm/evidence_description
		parameters:
