...
jQuery(document).ready(function(){
    ...
    jQuery('#guided_help_upload_trial_button').click(function(){
        jQuery('#guided_help_upload_trial_dialog').modal('show');
    });
    jQuery('#guided_help_create_trial_button').click(function(){
        jQuery('#guided_help_create_trial_dialog').modal('show');
    });
