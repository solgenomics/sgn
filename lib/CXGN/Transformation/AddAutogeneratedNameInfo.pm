...
sub add_info {
    ...
    my $coderef = sub {
        ...
        my $name_metadata_type_id = SGN::Model::Cvterm->get_cvterm_row($schema, 'autogenerated_name_metadata', 'project_property');
        my %name_metadata;
        $name_metadata{$prefix}{'current_serial_number'} = $current_number;
