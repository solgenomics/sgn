package CXGN::Transformation::CreateTransformantAutogeneratedNames;

=head1 NAME

CXGN::Transformation::CreateTransformantAutogeneratedNames - a module to create transformant autogenerated names based on autogenerated name metadata.
...
sub create_names {
    ...
    my $is_a_control = $source_info->{'isAcontrol'};
    my $vector_related_genes = $source_info->{'vectorRelatedGenes'};
    ...
    foreach my $n (1..$number_of_names) {
        ...
        foreach my $attribute (@$name_attributes) {
            ...
            if (ref $attribute eq ref {}) {
                ...
                if ($attribute eq 'vectorConstruct') {
                    if (($is_a_control) && (!$vector_related_genes)) {
                        push @all_name_components, 'VC';
                    } else {
