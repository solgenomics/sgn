...
sub get_transformation_info {
    ...
    $h->execute($plant_material_of_type_id, $accession_type_id, $vector_construct_of_type_id, $vector_construct_type_id, $transformant_of_type_id, $transformation_type_id, $transformant_stock_id);
