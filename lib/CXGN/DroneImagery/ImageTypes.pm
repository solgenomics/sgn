...
sub get_all_project_md_image_observation_unit_plot_polygon_types {
    ...
    return {
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndvi_mask_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_ndre_mask_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_1', channels=>[0], corresponding_channel=>0
        },
...
sub get_all_project_md_image_types_excluding_band_base_types {
    ...
    return [
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndvi_mask_imagery', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_thresholded_ndre_mask_imagery', 'project_md_image')->cvterm_id(),
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndvi_mask_imagery', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_original_background_removed_ndre_mask_imagery', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_fourier_transform_hpf30_blue_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_fourier_transform_hpf30_green_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id(),
        SGN::Model::Cvterm->get_cvterm_row($schema, 'observation_unit_polygon_fourier_transform_hpf30_red_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id(),
...
sub get_all_project_md_image_types_whole_images {
    ...
    return {
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_tgi_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_tgi_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_tgi_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_tgi_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_tgi_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_tgi_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_vari_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_vari_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_vari_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_vari_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_vari_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_vari_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndvi_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndvi_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndvi_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndvi_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndvi_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndvi_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndre_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndre_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndre_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndre_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_thresholded_ndre_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_thresholded_ndre_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_tgi_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_tgi_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_tgi_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_tgi_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_tgi_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_tgi_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_vari_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_vari_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_vari_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_vari_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_vari_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_vari_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndvi_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndvi_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndvi_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndvi_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndvi_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndvi_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndre_mask_original_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndre_mask_original_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndre_mask_original_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndre_mask_original_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'denoised_background_removed_ndre_mask_original_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'denoised_background_removed_ndre_mask_original_channel_3', channels=>[0], corresponding_channel=>2
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_denoised_stitched_image_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_denoised_stitched_image_channel_3', channels=>[0], corresponding_channel=>2
        },
        ...
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nrn_threshold_background_removed_stitched_drone_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_1', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_1', channels=>[0], corresponding_channel=>0
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_2', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_2', channels=>[0], corresponding_channel=>1
        },
        SGN::Model::Cvterm->get_cvterm_row($schema, 'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_3', 'project_md_image')->cvterm_id() => {
            name=>'calculate_fourier_transform_hpf30_nren_threshold_background_removed_stitched_drone_imagery_channel_3', channels=>[0], corresponding_channel=>2
        },
