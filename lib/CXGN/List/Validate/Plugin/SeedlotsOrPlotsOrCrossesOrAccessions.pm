...
package CXGN::List::Validate::Plugin::SeedlotsOrPlotsOrCrossesOrAccessions;
...
sub name {
    return "seedlots_or_plots_or_crosses_or_accessions";
}
...
sub validate {
    ...
    $h->execute($seedlot_type_id, $accession_type_id, $plot_type_id, $cross_type_id);
    my %result;
