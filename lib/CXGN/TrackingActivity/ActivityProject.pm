...
sub get_project_active_identifiers {
    ...
    $h->execute($stock_type_id, $tissue_culture_stockprop_type_id, $transformation_stockprop_type_id, $propagation_stockprop_type_id, $completed_metadata_type_id, $terminated_metadata_type_id, $stock_relationship_type_id,  $activity_project_id);
