...
sub get_trial_related_stock {
    ...
    my $q = "SELECT stock.stock_id, stock.uniquename, cvterm.name FROM stock_relationship
            ...
            OR stock_relationship.type_id = ? OR stock_relationship.type_id = ? OR stock_relationship.type_id = ?)
    ...
    $h->execute($stock_id, $plot_of_type_id, $plant_of_type_id, $subplot_of_type_id, $plant_of_subplot_type_id, $stock_id, $plot_of_type_id, $plant_of_type_id, $subplot_of_type_id, $plant_of_subplot_type_id);
