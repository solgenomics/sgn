...
sub search {
	...
	my @available = (
		...
		[['application/json'],['GET'],'search/variables',['2.0']],
		...
		[['application/json'],['GET'],'search/observationunits',['2.0']],
		...
		[['application/json'],['GET'],'search/callsets',['2.0']],
		...
		[['application/json'],['GET'],'search/markerpositions',['2.0']],
		...
		[['application/json'],['GET'],'search/samples',['2.0']],
		...
		[['application/json'],['GET'],'search/variants',['2.0']],
		...
		[['application/json'],['GET'],'search/variantsets',['2.0']],
	);
