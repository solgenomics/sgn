...
sub calls {
	...
	my @available = (
		...
		['trials/{trialDbId}', ['json'], ['GET'], ['1.0'] ],
		['studies-search', ['json'], ['GET','POST'], ['1.0'] ],
		['studies/{studyDbId}', ['json'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/germplasm', ['json'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/observationvariables', ['json'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/observationunits', ['json'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/table', ['json','csv','xls','tsv'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/layout', ['json'], ['GET'], ['1.0'] ],
		['studies/{studyDbId}/observations', ['json'], ['GET'], ['1.0'] ],
		...
		['traits', ['json'], ['GET'], ['1.0'] ],
		['traits/{traitDbId}', ['json'], ['GET'], ['1.0'] ],
		['maps', ['json'], ['GET'], ['1.0'] ],
		['maps/{mapDbId}', ['json'], ['GET'], ['1.0'] ],
		['maps/{mapDbId}/positions', ['json'], ['GET'], ['1.0'] ],
		['maps/{mapDbId}/positions/id', ['json'], ['GET'], ['1.0'] ],
		['locations', ['json'], ['GET'], ['1.0'] ],
		['variables/datatypes', ['json'], ['GET'], ['1.0'] ],
		['ontologies', ['json'], ['GET'], ['1.0'] ],
		['variables', ['json'], ['GET'], ['1.0'] ],
		['variables/{observationVariableDbId}', ['json'], ['GET'], ['1.0'] ],
		['variables-search', ['json'], ['GET','POST'], ['1.0'] ],
		['samples-search', ['json'], ['GET','POST'], ['1.0'] ],
		['samples/{sampleDbId}', ['json'], ['GET'], ['1.0'] ],
	);
