...
sub get_autogenerated_name_metadata_by_breeding_program {
    ...
    my $transformant_autogenerated_name_metadata_cvterm = SGN::Model::Cvterm->get_cvterm_row($schema, 'transformant_autogenerated_name_metadata', 'project_property');
    my $program = $schema->resultset('Project::Project')->find({ project_id => $breeding_program_id});

    my $name_metadata_hashes;
    my $name_metadata_projectprop_rs = $program->projectprops({type_id => $transformant_autogenerated_name_metadata_cvterm->cvterm_id});
