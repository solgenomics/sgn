...
sub get_cached_file_VCF {
    ...
    print STDERR "CHECK SEARCH FORBID CACHE =".Dumper($forbid_cache)."\n";
...
#        print STDERR "ALL PROTOCOL INFO LINE =".Dumper(\@all_protocol_info_lines)."\n";
#        print STDERR "ALL MARKER OBJECT =".Dumper(\@all_marker_objects)."\n";
        foreach (@all_marker_objects) {
            $self->_filtered_markers()->{$_->{name}}++;
        }
