# Clone Unigene download script for SGN database
# Lukas Mueller, August 12, 2003

# This bulk download option handles the query 
# Of Clones of type Unigene.
...
=head1 DESCRIPTION
  ...
  Clone Unigene Ids entered. It then determines the information the user is
  searching for (Clone Name, SGN_C, SGN_T, SGN_E, SGN_U, Build Number,
  Chipname, SGN_M, TUS, Maunal Annotayion, Automatic Annotation, 
...
package CXGN::Bulk::CloneUnigene;
use base "CXGN::Bulk";
