# Array Spot Unigene download script for SGN database
# Lukas Mueller, August 12, 2003

# This bulk download option handles the query 
# Of Array Spot of type Unigene.
...
=head1 DESCRIPTION
  ...
  Array Spot Unigene Ids entered. It then determines the information the 
  user is searching for (SGN_M, Chipname, TUS, Clone Name, SGN_T, SGN_E, SGN_U, Build Number, Manual Annotation, Automant) and preforms the appropriate querying of the 
...
package CXGN::Bulk::ArraySpotUnigene;
use base "CXGN::Bulk";
