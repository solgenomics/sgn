# Bulk BAC End Trim download script for SGN database
# Lukas Mueller, August 12, 2003

# This bulk download option handles the query 
# Of BAC Ends of type Trimed.
...
=head1 DESCRIPTION
  ...
  BAC End Trimed Ids entered. It then determines the information the user is
  searching for (Bac IDs, Clone Type, Orgonism Name, Accession Name,
  Library Name, Estimated Length, Genbank Accessionm, Bac End Sequence, 
  and Quakl Value Sequence) and preforms the appropriate querying of the 
...
sub process_ids
{
	...
	next;
      ...
      # trim seq and qual value
      my $qualvalue = $gss->trimmed_qual;
      my $bacseq = $gss->trimmed_seq;
