...
########
    ...
    print STDERR "\nkinship_run_analysis combo_pops_id: $combo_pops_id\n";
...
sub kinship_query_jobs {
    ...
    print STDERR "\nkinship query jobs popid: $kinship_pop_id\n";
...
#     {
#         $c->stash->{dataset_id} = $kinship_pop_id =~ s/dataset_//;
...
# 	$c->controller('solGS::AsyncJob')->get_trials_genotype_query_jobs_args($c, $trials, $protocol_id);
# 	$c->stash->{kinship_geno_query_jobs} = $c->stash->{trials_genotype_query_jobs_args};
#     }
