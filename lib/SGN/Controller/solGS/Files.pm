...
sub analysis_error_file {
    ...
    my $cache_dir = $c->stash->{$type . '_cache_dir'} || $c->stash->{solgs_cache_dir};
...
sub analysis_report_file {
    ...
    my $cache_dir = $c->stash->{$analysis_type . '_cache_dir'} || $c->stash->{solgs_cache_dir};
