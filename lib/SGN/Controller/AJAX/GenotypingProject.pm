...
sub project_genotyping_data_delete : Path('/ajax/breeders/project_genotyping_data_delete') : ActionClass('REST') { }

sub project_genotyping_data_delete_GET : Args(0) {
    my $self = shift;
    my $c = shift;
    ...
    my $genotyping_data = CXGN::Genotype::GenotypingDataDelete->new( { bcs_schema => $schema, genotyping_project_id => $genotyping_project_id });
