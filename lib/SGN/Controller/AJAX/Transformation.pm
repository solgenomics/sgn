...
sub add_autogenerated_name_info_POST :Args(0){
    ...
    print STDERR "PROGRAM ID =".Dumper($breeding_program_id)."\n";
    print STDERR "PREFIX =".Dumper($prefix)."\n";
    print STDERR "CURRENT NUM =".Dumper($current_serial_number)."\n";
    print STDERR "NUM DIGITS =".Dumper($number_of_digits)."\n";
    print STDERR "DESCRIPYION =".Dumper($description)."\n";
