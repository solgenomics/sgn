...
sub upload_phenotype_spreadsheet_verify :  Path('/ajax/phenotype/upload_spreadsheet_verify') : ActionClass('REST') { }
sub upload_phenotype_spreadsheet_verify_POST : Args(0) {
