...
#        my $last_serial_number = $name_metadata->{$prefix}->{'last_serial_number'};
...
#        push @autogenerated_name_metadata, [$prefix, $last_serial_number, $description, $person_name, $created_date];
#    }
