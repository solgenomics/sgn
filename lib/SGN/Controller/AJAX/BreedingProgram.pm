...
sub add_autogenerated_name_metadata : Path('/ajax/add_autogenerated_name_metadata') : ActionClass('REST') {}
...
sub add_autogenerated_name_metadata_POST :Args(0){
    ...
    my $last_serial_number;
    if ($name_type eq 'transformant') {
        $last_serial_number = $c->req->param('last_serial_number');
    }
