...
sub get_trial_plot_order : Path('/ajax/breeders/trial_plot_order') : Args(0) {
    ...
    if ( $type eq 'planting' || $type eq 'harvest' ) {
        ...
        # Add CSV headers
        my @headers = ($col, "type", "location_name", "trial_name", "plot_number", "plot_name", "accession_name", "entry_number", "seedlot_name", "row_number", "col_number", "rep_number", "block_number", "is_a_control", "is_a_filler");
        push(@data, \@headers);
        ...
        # Add CSV headers
        my @headers = ("PLTID", "Range", "Row", "type", "location_name", "trial_name", "plot_number", "plot_name", "accession_name", "entry_number", "seedlot_name", "rep_number", "block_number", "is_a_control", "is_a_filler");
        push(@data, \@headers);
