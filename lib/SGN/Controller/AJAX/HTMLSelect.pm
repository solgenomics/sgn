...
sub get_trial_plot_select : Path('/ajax/html/select/plots_from_trial/') Args(0) {
    ...
    my $plots_q = "
    WITH plot AS 
        (SELECT subject_id AS plot_id, myplot.uniquename AS plot_name, accession.stock_id AS accession_id, accession.uniquename AS accession_name FROM stock_relationship 
    ...
    my $html = "<table style=\"width:100%\" id=\"plots_from_trial_select_table\"><thead><tr><th></th><th>Plot</th><th>Field Coordinates (row,column)</th><th>Rep</th><th>Block</th><th>Accession</th><th>Synonyms</th></tr></thead><tbody>";
...
sub get_trial_subplot_select : Path('/ajax/html/select/subplots_from_trial/') Args(0) {
    ...
    my $html = "<table style=\"width:100%\" id=\"subplots_from_trial_select_table\"><thead><tr><th></th><th>Subplot</th><th>Parent Plot</th><th>Accession</th><th>Synonyms</th></tr></thead><tbody>";
...
sub get_trial_plant_select : Path('/ajax/html/select/plants_from_trial/') Args(0) {
    ...
    my $html = "<table style=\"width:100%\" id=\"plants_from_trial_select_table\"><thead><tr><th></th><th>Plant</th>$subplot_header<th>Parent Plot</th><th>In-Plot Coordinates (row,column)</th><th>Accession</th><th>Synonyms</th></tr></thead><tbody>";
