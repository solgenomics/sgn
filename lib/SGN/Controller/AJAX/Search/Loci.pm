...
# contains    'ilike', '%' . $any_name . '%' 
# exactly     'ilike , $any_name
# starts_with 'ilike , $any_name . '%'
# ends_with   'ilike , '%'.$any_name 
 
my $or_conditions = [ 
     { locus         => {'ilike', '%'.$params->{any_name}.'%'} },  
     { locus_name    => {'ilike', '%'.$params->{any_name}.'%'} },  
     { locus_symbol  => {'ilike', '%'.$params->{any_name}.'%'} }, 
     { description   => {'ilike', '%'.$params->{any_name}.'%'} },  
     { gene_activity => {'ilike', '%'.$params->{any_name}.'%'} } 
    ] ; 
