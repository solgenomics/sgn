...
sub trial_download : Chained('trial_init') PathPart('download') Args(1) {
    ...
    if ($data_level eq 'plate'){
        $selected_cols = {'trial_name'=>1, 'acquisition_date'=>1, 'plot_name'=>1, 'plot_number'=>1, 'row'=>1, 'column'=>1, 'source_observation_unit_name'=>1, 'dna_person'=>1, 'notes'=>1, 'tissue_type'=>1, 'extraction'=>1, 'concentration'=>1, 'volume'=>1, 'is_blank'=>1};
    }
