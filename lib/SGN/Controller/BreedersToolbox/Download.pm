...
sub download_phenotypes_action : Path('/breeders/trials/phenotype/download') Args(0) {
    ...
    my $exclude_phenotype_outlier = $c->req->param("exclude_phenotype_outlier") && $c->req->param("exclude_phenotype_outlier") ne 'null' ? $c->req->param("exclude_phenotype_outlier") : 0;
