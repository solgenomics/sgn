...
# my $page=CXGN::Page->new("Maps available on SGN");
# $page->header();
...
# View two chromosomes from two different maps at the same time, displaying the relationships between the chromosomes and additional information such as associated physical map, inbred lines, and rulers.<br /><br />
# <b>Examples</b>: 
# <ul>
...
# </ul>
# <br />
# Comparative viewer <a href="/help/cview.pl">help page</a>
