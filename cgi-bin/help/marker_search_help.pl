...
use strict;
use CXGN::Page;
my $page=CXGN::Page->new('cview.html','html2pl converter');
$page->header('SGN: Marker search help');

print <<EOHTML;

<p>
The <a href="/search/markers/markersearch.pl">marker search</a> is a
tool for locating markers in SGN's database. 
</p>

<img src="/documents/help/screenshots/marker_search_form.png" alt="screenshot of marker search form" style="margin: auto; border: 1px solid black;" />

<h4>1. Marker name</h4>
<p>
If you know the name of your marker, type it in. By default, the database will be searched for all markers with a name that <i>starts with</i> what you type in.For example, if you type in "TG1", your results might include TG1, TG10, TG11, TG150, etc.
</p><p>
...
<ul>
<li><b>COS</b> - Conserved Ortholog Set, markers that have been mapped in both tomato and <i>Arabidopsis</i>. </li>
<li><b>COSII</b> - Conserved Ortholog Set, part II - markers that have been mapped in several asterid species, including several solanaceous species. <a href="http://www.sgn.cornell.edu/markers/cosii_markers.pl">Learn more about COSII markers here</a></li>
<li><b>KFG</b> - Known Function Genes - markers that correspond to known genes in tomato</li>
<li><b>P</b> - a subset of our EST collection</li>
<li><b>TM</b> - also EST-derived markers</li>
</ul>
...
<h4>9. Maps</h4>
<p>
This multiple-select box shows a list of our available maps. For more information on these maps, see the <a href="/cview/">map overview page</a>.
</p>
