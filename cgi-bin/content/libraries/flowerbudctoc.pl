use strict;
use CXGN::Page;
my $page=CXGN::Page->new('flowerbudctoc.html','html2pl converter');
$page->header('8 mm to pre-anthesis flower buds');
print<<END_HEREDOC;
  ...
  <center>
    ...
    border="0">
      <tr>
        <td>
          <center>
            <h2>8 mm to pre-anthesis flower buds</h2>
          </center>
          ...
          <table summary="" width="100\%" cellspacing="5">
            ...
            <tr valign="top">
              ...
              <td>8 mm to pre-anthesis flower buds from 4-8
              week-old plants</td>
            </tr>
