use strict;
use CXGN::Page;
my $page=CXGN::Page->new('Map submission formats','Lukas');
$page->header("SGN Map Data Submission Guidelines", "SGN Map Data Submission Guidelines");
...
<li><b>protocol</b>: The type of experiment used to map the marker. Currently we support CAPS, SSR, RFLP, SNP, and AFLP. We can accept most PCR-based markers; <a href="/contact/form">contact SGN</a> if you would like to submit marker types that are not listed here.</li>
</ul>
