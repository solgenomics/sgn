...
print <<END_HEREDOC;
     ...
     <td width="33%" class="left">
	  ...
	  <br />
	    ...
	    <div class="boxsubcontent">
	      <a class="creativitylinks" href="/content/sgn_data.pl#Solanumlycopersicum">Tomato</a><br /> 
	    ...
	    <div class="boxsubcontent">
	      ...
	      <a class="creativitylinks" href="/documents/markers/cosii.xls">New COSII data available now</a><br />
            </div>
