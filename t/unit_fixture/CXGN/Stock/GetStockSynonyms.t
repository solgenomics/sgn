...
ok(my $resultsA = $slookup
  ->get_stock_synonyms('stock_id', 'accession', ['38857','38840','38863']),
  "Find synonyms by ID");
print STDERR Dumper $resultsA;

ok(my $resultsB = $slookup
  ->get_stock_synonyms('uniquename', 'accession', ['new_test_crossP005','new_test_crossP009','test_accession2']),
  "Find synonyms by uniquename");
print STDERR Dumper $resultsB;

ok(my $resultsC = $slookup
  ->get_stock_synonyms('any_name', 'accession', ['test_accession2_synonym1','new_test_crossP009','test_accession1','test_accession2','test_accession3_synonym1']),
