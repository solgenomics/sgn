...
for my $extension ("xls", "xlsx") {
    ...
    my $cross_fieldbook_tempfile = "/tmp/test_create_cross_trial_fieldbook.$extension";
    ...
    my $family_fieldbook_tempfile = "/tmp/test_create_family_trial_fieldbook.$extension";
    ...
    #print STDERR Dumper @contents->[0]->[0];
    is($family_contents->[0]->{'type'}, $extension, "check that type of file is correct");
