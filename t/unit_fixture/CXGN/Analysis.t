...
for my $extension ("xls", "xlsx") {
    ...
    is_deeply($saved_analysis_object, {
        'model_id'    => 3 + ($extension eq 'xlsx' ? 2 : 0),
        'success'     => 1,
        'analysis_id' => 166 + ($extension eq 'xlsx' ? 2 : 0),
    });
    ...
    my $analysis_training_data_file_dummy = $t->config->{basepath} . "/t/data/trial/upload_phenotypin_spreadsheet.$extension";
