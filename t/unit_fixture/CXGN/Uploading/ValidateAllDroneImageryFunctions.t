...
for my $extension ("xls", "xlsx") {
    ...
    my $file_previous_imaging_events = "/home/production/public/static_content/imagebreed/RiceExampleRGBandDSMGeoJSONImagingEvent.$extension";

    my $bulk_loading_csv = $f->config->{basepath} . "/t/data/imagebreed/bulk_loading/BTI_rig_images.$extension";
