...
my %stock_polygons = ('test_trial1' => [{'x'=>100, 'y'=>100}, {'x'=>120, 'y'=>100}, {'x'=>120, 'y'=>80}, {'x'=>100, 'y'=>70}, {'x'=>100, 'y'=>100}]);
...
$ua = LWP::UserAgent->new;
my $response_background_removed_percentage = $ua->post('http://localhost:3010/api/drone_imagery/remove_background_percentage_save?sgn_session_id='.$sgn_session_id.'&image_id='.$message_hash_raster->{drone_run_band_image_ids}->[0].'&image_type_list=threshold_background_removed_stitched_drone_imagery_blue&lower_threshold_percentage=20&upper_threshold_percentage=20&drone_run_band_project_id='.$message_hash_raster->{drone_run_band_project_ids}->[0]);
