...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'metadata' => {'status' => [{}],'datafiles' => [],'pagination' => {'totalCount' => 9,'totalPages' => 5,'pageSize' => 2,'currentPage' => 3}},'result' => {'data' => [{'trialDbId' => undef,'programName' => 'test','active' => '','studyName' => 'test_t','locationDbId' => '23','additionalInfo' => {'design' => 'CRD','description' => 'test tets'},'studyType' => undef,'trialName' => undef,'endDate' => undef,'studyDbId' => 144,'seasons' => ['2016'],'locationName' => 'test_location','startDate' => undef,'programDbId' => 134},{'trialDbId' => undef,'programName' => 'test','active' => '','studyName' => 'test_trial','locationDbId' => '23','additionalInfo' => {'description' => 'test trial','design' => 'CRD'},'studyType' => undef,'endDate' => undef,'trialName' => undef,'studyDbId' => 137,'seasons' => ['2014'],'startDate' => undef,'locationName' => 'test_location','programDbId' => 134}]}}, 'studies-search');

$mech->post_ok('http://localhost:3010/brapi/v1/studies-search?pageSize=2&page=0&studyLocations=test_location' );
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'metadata' => {'pagination' => {'currentPage' => 0,'pageSize' => 2,'totalCount' => 5,'totalPages' => 3},'datafiles' => [],'status' => [{}]},'result' => {'data' => [{'studyName' => 'CASS_6Genotypes_Sampling_2015','programName' => 'test','locationName' => 'test_location','endDate' => undef,'locationDbId' => '23','trialName' => undef,'active' => '','additionalInfo' => {'design' => 'RCBD','description' => 'Example trial from cassbase'},'seasons' => ['2015'],'programDbId' => 134,'studyDbId' => 165,'trialDbId' => undef,'studyType' => undef,'startDate' => undef},{'locationName' => 'test_location','programName' => 'test','studyName' => 'Kasese solgs trial','additionalInfo' => {'design' => 'Alpha','description' => 'This trial was loaded into the fixture to test solgs.'},'active' => '','trialName' => undef,'locationDbId' => '23','endDate' => undef,'studyDbId' => 139,'programDbId' => 134,'seasons' => ['2014'],'studyType' => 'Clonal Evaluation','startDate' => undef,'trialDbId' => undef}]}}, 'studies-search');
...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'result' => {'data' => [{'studyDbId' => 165,'trialName' => undef,'locationName' => 'test_location','additionalInfo' => {'design' => 'RCBD','description' => 'Example trial from cassbase'},'studyName' => 'CASS_6Genotypes_Sampling_2015','programName' => 'test','locationDbId' => '23','programDbId' => 134,'active' => '','startDate' => undef,'endDate' => undef,'seasons' => ['2015'],'studyType' => undef,'trialDbId' => undef},{'studyType' => 'Clonal Evaluation','seasons' => ['2014'],'endDate' => undef,'active' => '','startDate' => undef,'trialDbId' => undef,'programDbId' => 134,'locationDbId' => '23','programName' => 'test','studyName' => 'Kasese solgs trial','additionalInfo' => {'description' => 'This trial was loaded into the fixture to test solgs.','design' => 'Alpha'},'locationName' => 'test_location','trialName' => undef,'studyDbId' => 139}]},'metadata' => {'pagination' => {'totalPages' => 3,'totalCount' => 6,'currentPage' => 0,'pageSize' => 2},'datafiles' => [],'status' => [{}]}}, 'studies-search');
