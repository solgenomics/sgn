...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'result' => {'countryOfOriginCode' => '','accessionNumber' => 'test5P004','germplasmPUI' => 'test5P004','synonyms' => '','germplasmName' => 'test5P004','instituteName' => '','subtaxaAuthority' => '','genus' => 'Lycopersicon','germplasmSeedSource' => '','biologicalStatusOfAccessionCode' => '','speciesAuthority' => '','instituteCode' => '','pedigree' => 'test_accession4/test_accession5','species' => 'Solanum lycopersicum','donors' => [{'donorGermplasmName' => undef,'donorInstituteCode' => undef,'donorAccessionNumber' => undef,'germplasmPUI' => undef}],'germplasmDbId' => '38876','acquisitionDate' => '','defaultDisplayName' => 'test5P004','commonCropName' => 'tomato','typeOfGermplasmStorageCode' => '','subtaxa' => ''},'metadata' => {'pagination' => {'pageSize' => 1,'totalCount' => 1,'totalPages' => 1,'currentPage' => 0},'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Germplasm'},{'success' => 'Germplasm-search result constructed'}],'datafiles' => []}}, 'germplasm detail');

$mech->get_ok('http://localhost:3010/brapi/v1/germplasm/38876/pedigree');
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'result' => {'parent2Id' => 38844,'germplasmDbId' => '38876','parent1Id' => 38843,'pedigree' => 'test_accession4/test_accession5'},'metadata' => {'pagination' => {'pageSize' => 1,'currentPage' => 0,'totalPages' => 1,'totalCount' => 1},'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Germplasm'},{'success' => 'Germplasm-pedigree result constructed'}],'datafiles' => []}}, 'germplasm pedigree');

$mech->get_ok('http://localhost:3010/brapi/v1/germplasm/38937/markerprofiles');
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'metadata' => {'datafiles' => [],'pagination' => {'currentPage' => 0,'totalCount' => 2,'totalPages' => 1,'pageSize' => 20},'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Germplasm'},{'success' => 'Germplasm-markerprofiles result constructed'}]},'result' => {'germplasmDbId' => '38937','markerProfiles' => [1622,1934]}}, 'germplasm markerprofile');
...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'metadata' => {'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Markerprofiles'},{'success' => 'Markerprofiles detail result constructed'}],'pagination' => {'totalCount' => 500,'totalPages' => 25,'currentPage' => 0,'pageSize' => 20},'datafiles' => []},'result' => {'extractDbId' => 'UG120156|78265','uniqueDisplayName' => 'UG120156','markerprofileDbId' => '1627','data' => [{'S5_36739' => 'BB'},{'S13_92567' => 'BB'},{'S69_57277' => 'BB'},{'S80_224901' => 'AA'},{'S80_232173' => 'BB'},{'S80_265728' => 'AA'},{'S97_219243' => 'AB'},{'S224_309814' => 'BB'},{'S248_174244' => 'BB'},{'S318_245078' => 'AA'},{'S325_476494' => 'AA'},{'S341_311907' => 'BB'},{'S341_745165' => 'BB'},{'S341_927602' => 'BB'},{'S435_153155' => 'AA'},{'S620_130205' => 'BB'},{'S784_76866' => 'BB'},{'S821_289681' => 'AB'},{'S823_109683' => 'AA'}],'germplasmDbId' => 39007,'analysisMethod' => 'GBS ApeKI genotyping v4'}}, 'markerprofile');
...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'metadata' => {'datafiles' => [],'pagination' => {'totalCount' => 1,'totalPages' => 1,'currentPage' => 0,'pageSize' => 20},'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Programs'},{'success' => 'Program list result constructed'}]},'result' => {'data' => [{'programDbId' => 134,'abbreviation' => 'test','objective' => 'test','leadPerson' => '','name' => 'test'}]}}, 'programs');
...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'result' => {'data' => [{'description' => 'seedling','name' => 'Seedling Nursery','studyTypeDbId' => 76464},{'studyTypeDbId' => 76514,'description' => undef,'name' => 'Advanced Yield Trial'},{'studyTypeDbId' => 76515,'description' => undef,'name' => 'Preliminary Yield Trial'},{'description' => undef,'name' => 'Uniform Yield Trial','studyTypeDbId' => 76516},{'description' => undef,'name' => 'Variety Release Trial','studyTypeDbId' => 77105},{'description' => undef,'name' => 'Clonal Evaluation','studyTypeDbId' => 77106}]},'metadata' => {'datafiles' => [],'status' => [{'info' => 'BrAPI base call found with page=0, pageSize=20'},{'info' => 'Loading CXGN::BrAPI::v1::Studies'},{'success' => 'StudyTypes result constructed'}],'pagination' => {'pageSize' => 20,'currentPage' => 0,'totalCount' => 6,'totalPages' => 1}}}, 'studyTypes');

$mech->get_ok('http://localhost:3010/brapi/v1/studyTypes?pageSize=2&page=2' );
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'result' => {'data' => [{'studyTypeDbId' => 76464,'name' => 'Seedling Nursery','description' => 'seedling'},{'studyTypeDbId' => 76514,'name' => 'Advanced Yield Trial','description' => undef},{'studyTypeDbId' => 76515,'name' => 'Preliminary Yield Trial','description' => undef},{'description' => undef,'name' => 'Uniform Yield Trial','studyTypeDbId' => 76516},{'name' => 'Variety Release Trial','description' => undef,'studyTypeDbId' => 77105},{'studyTypeDbId' => 77106,'name' => 'Clonal Evaluation','description' => undef}]},'metadata' => {'datafiles' => [],'pagination' => {'pageSize' => 2,'totalCount' => 6,'totalPages' => 3,'currentPage' => '2'},'status' => [{'info' => 'BrAPI base call found with page=2, pageSize=2'},{'info' => 'Loading CXGN::BrAPI::v1::Studies'},{'success' => 'StudyTypes result constructed'}]}}, 'studyTypes');
