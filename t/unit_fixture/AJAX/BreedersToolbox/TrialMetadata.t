...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'data' => [['<a href="/cvterm/70741/view">dry matter content percentage|CO:0000092</a>','25.01','16.30','39.90','5.06','20.24%',464,'32.95%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70741)"><span class="glyphicon glyphicon-stats"></span></a>'],['<a href="/cvterm/70666/view">fresh root weight|CO:0000012</a>','5.91','0.04','38.76','5.37','90.80%',469,'32.23%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70666)"><span class="glyphicon glyphicon-stats"></span></a>'],['<a href="/cvterm/70773/view">fresh shoot weight measurement in kg|CO:0000016</a>','13.23','0.50','83.00','10.70','80.88%',494,'28.61%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70773)"><span class="glyphicon glyphicon-stats"></span></a>']]});
...
is_deeply(\@last_n, [['<a href="/stock/38970/view">UG120103</a>','<a href="/cvterm/70773/view">fresh shoot weight measurement in kg|CO:0000016</a>','5.50','4.50','6.50','1.41','25.71%',2,'0%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70773)"><span class="glyphicon glyphicon-stats"></span></a>'],['<a href="/stock/38916/view">UG120039</a>','<a href="/cvterm/70773/view">fresh shoot weight measurement in kg|CO:0000016</a>','25.50','25.50','25.50',undef,0,1,'50%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70773)"><span class="glyphicon glyphicon-stats"></span></a>'],['<a href="/stock/39142/view">UG130011</a>','<a href="/cvterm/70773/view">fresh shoot weight measurement in kg|CO:0000016</a>','16.00','13.50','18.50','3.54','22.10%',2,'0%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70773)"><span class="glyphicon glyphicon-stats"></span></a>'],['<a href="/stock/39049/view">UG120202</a>','<a href="/cvterm/70773/view">fresh shoot weight measurement in kg|CO:0000016</a>','6.50','6.50','6.50',undef,0,1,'0%','<a href="#raw_data_histogram_well" onclick="trait_summary_hist_change(70773)"><span class="glyphicon glyphicon-stats"></span></a>']]);
...
$response = decode_json $mech->content;
print STDERR Dumper $response;
is_deeply($response, {'traits_assayed' => [[[70741,'dry matter content percentage|CO:0000092'],[70666,'fresh root weight|CO:0000012'],[70773,'fresh shoot weight measurement in kg|CO:0000016']]]});
