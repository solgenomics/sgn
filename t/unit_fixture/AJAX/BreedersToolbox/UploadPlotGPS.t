...
my $file = $f->config->{basepath}."/t/data/trial/test_trial_plot_gps.xls";
my $ua = LWP::UserAgent->new;
$response = $ua->post(
        'http://localhost:3010/ajax/breeders/trial/137/upload_plot_gps',
        Content_Type => 'form-data',
        Content => [
            trial_upload_plot_gps_file => [ $file, 'test_trial_plot_gps.xls', Content_Type => 'application/vnd.ms-excel', ],
