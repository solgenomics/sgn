...
my $server = $ENV{SGN_TEST_SERVER} || die "Need SGN_TEST_SERVER environment variable set";
...
eval { 
    ...
    #
    $m->get_ok("$server/solpeople/login.pl?logout=yes", "Request logout page");
