...
my $treatment_cvterm = $schema->resultset('Cv::Cvterm')->find( { name => 'test treatment' } );
my $treatment_id = $treatment_cvterm->cvterm_id();

is_deeply([@response[0..3]], [[qq{<a href="/cvterm/$treatment_id/view">test treatment|EXPERIMENT_TREATMENT:0000002=0</a>},'<a href="/cvterm/70741/view">dry matter content percentage|CO_334:0000092</a>','24.95','16.30','39.90','5.07','20.32%',252,'27.17%','<span class="glyphicon glyphicon-stats"></span>'],[qq{<a href="/cvterm/$treatment_id/view">test treatment|EXPERIMENT_TREATMENT:0000002=1</a>},'<a href="/cvterm/70741/view">dry matter content percentage|CO_334:0000092</a>','25.08','16.30','35.40','5.06','20.18%',212,'38.73%','<span class="glyphicon glyphicon-stats"></span>'],[qq{<a href="/cvterm/$treatment_id/view">test treatment|EXPERIMENT_TREATMENT:0000002=0</a>},'<a href="/cvterm/70666/view">fresh root weight|CO_334:0000012</a>','5.74','0.04','30.50','5.30','92.45%',255,'26.30%','<span class="glyphicon glyphicon-stats"></span>'],[qq{<a href="/cvterm/$treatment_id/view">test treatment|EXPERIMENT_TREATMENT:0000002=1</a>},'<a href="/cvterm/70666/view">fresh root weight|CO_334:0000012</a>','6.12','0.04','38.76','5.45','89.02%',214,'38.15%','<span class="glyphicon glyphicon-stats"></span>']], "check phenotypes grouped by treatments");
