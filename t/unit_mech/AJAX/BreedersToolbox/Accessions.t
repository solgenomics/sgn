...
$mech->post_ok('http://localhost:3010/ajax/accession_list/add', [ 'full_info'=>$json->encode(\@full_info), 'allowed_organisms'=>$json->encode(['Manihot esculenta']), 'archived_filename' => 'unit_mech_accessions_test' ]);
$response = decode_json $mech->content;
print STDERR Dumper $response;
