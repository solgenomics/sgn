...
# $response = decode_json $resp->{_content};
# print STDERR "\n\n" . Dumper $response;
# is_deeply($response,  {'result' => {'lastUpdate' => undef,'startDate' => undef,'active' => JSON::true,'growthFacility' => undef,'observationUnitsDescription' => undef,'studyName' => 'Kasese solgs trial','dataLinks' => [],'experimentalDesign' => {'PUI' => 'CRD','description' => 'CRD'},'observationLevels' => undef,'documentationURL' => '','locationDbId' => '23','studyDbId' => 139,'endDate' => undef,'contacts' => undef,'commonCropName' => 'Cassava','trialDbId' => 134, 'studyType' => 'Clonal Evaluation', 'externalReferences' => undef,'studyPUI' => undef,'studyDescription' => 'This trial was loaded into the fixture to test solgs.','culturalPractices' => undef,'seasons' => ['2014'],'additionalInfo' => {'programName' => 'test','programDbId' => '134'},'environmentParameters' => undef,'studyCode' => undef,'license' => '','trialName' => 'test','locationName' => 'test_location'},'metadata' => {'pagination' => {'pageSize' => 10,'currentPage' => 0,'totalPages' => 1,'totalCount' => 1},'datafiles' => [],'status' => [{'messageType' => 'INFO','message' => 'BrAPI base call found with page=0, pageSize=10'},{'messageType' => 'INFO','message' => 'Loading CXGN::BrAPI::v2::Studies'},{'messageType' => 'INFO','message' => 'Studies result constructed'}]}});
