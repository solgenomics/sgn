...
$d->while_logged_in_as("submitter", sub {
    ...
    $d->find_element_ok('run_cluster', 'id', 'run cluster')->click();
    sleep(20);
    $d->find_element_ok('//img[@id="k-means-plot-139-139-DMCP-3-FRW-5-genotype-k-5-gp-1-sp-15"]', 'xpath', 'check k-means plot')->click();  
    sleep(5);
   ...
   # sleep(2);
    ...
    $d->find_element_ok('run_cluster', 'id', 'run cluster')->click();
    sleep(40);
    $d->find_element_ok('//img[@id="k-means-plot-2804608595-traits-1971973596-genotype-k-4-gp-1"]', 'xpath', 'check k-means plot')->click();  
    sleep(5);
