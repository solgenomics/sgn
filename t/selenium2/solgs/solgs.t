...
sleep(3);
$d->find_element_ok('dry matter content percentage', 'link_text', 'go to trials with trait data page')->click();
sleep(3);
...
$trial_search->send_keys('Uganda Cassava Training Population');
sleep(5);
