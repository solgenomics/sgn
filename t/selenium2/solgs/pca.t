...
$d->while_logged_in_as("submitter", sub {
    ...
    sleep(5);
    $d->find_element_ok('//select[@id="pca_data_type_select"]/option[text()="Genotype"]', 'xpath', 'select data type')->click();
    sleep(2);
    ...
    $d->find_element_ok('//input[@value="Go"]', 'xpath', 'go btn')->click();
    sleep(5);
    $d->find_element_ok('//select[@id="pca_data_type_select"]/option[text()="Phenotype"]', 'xpath', 'select data type')->click();
    sleep(2);
    $d->find_element_ok('Run PCA', 'partial_link_text', 'run pca')->click();
    sleep(40);
    ...
    $d->get_ok('/pca/analysis', 'pca home page');     
    sleep(5);
    $d->find_element_ok('//select[@id="pca_pops_list_select"]/option[text()="Dataset Kasese Clones"]', 'xpath', 'clones dataset')->click();
    sleep(5);
    $d->find_element_ok('//input[@value="Go"]', 'xpath', 'go btn')->click();
    sleep(5);
    $d->find_element_ok('//select[@id="pca_data_type_select"]/option[text()="Genotype"]', 'xpath', 'select data type')->click();
    ...
    $d->get_ok('/solgs/trait/70741/population/139', 'open model page');
    sleep(10);
    ...
    $d->get_ok('/solgs/selection/141/model/139/trait/70741', 'selection prediction page');
    sleep(5);
