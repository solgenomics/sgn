...
$d->while_logged_in_as(
    ...
    sub {
        ...
        sleep(5);
        $d->find_element_ok(
            '//select[@id="cluster_genotypes_list_select"]/option[text()="'
              . $accessions_list_name . '"]',
            'xpath',
            'select clones list'
        )->click();
        sleep(5);
        $d->find_element_ok( '//input[@value="Go"]', 'xpath', 'go btn' )
          ->click();
        sleep(5);
...
'//select[@id="list_type_selection_pops_list_select"]/option[text()="'
        ...
        sleep(5);
        $d->find_element_ok( '//input[@value="Go"]', 'xpath',
...
'//table[@id="list_type_selection_pops_table"]//*[contains(text(), "Predict")]',
        ...
        $d->find_element_ok(
            '//div[@id="list_type_selection_pop_load"]/input[@value="Go"]',
...
'//div[@id="list_type_selection_pops_list"]/select[@id="list_type_selection_pops_list_select"]/option[text()="'
        ...
        $d->driver->execute_script(
            ...
            $clustering );
        sleep(2);
        $d->find_element_ok( 'cluster_dropdown', 'class', 'select list sl pop' )
          ->click();
        sleep(3);
        $d->find_element_ok(
            '//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="'
              . $accessions_list_name . '"]',
            'xpath',
...
'//div[@id="list_type_selection_pops_list"]/select[@id="list_type_selection_pops_list_select"]/option[text()="'
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="Kasese solgs trial"]',
            'xpath',
            'select trial tr pop'
        )->click();
        sleep(3);
...
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="Kasese solgs trial"]',
        ...
        $d->driver->execute_script(
            ...
            $cor );
        sleep(5);
        $d->find_element_ok( 'si_dropdown', 'class', 'select list sl pop' )
          ->click();
        sleep(3);
        $d->find_element_ok(
'//dl[@class="si_dropdown"]/dd/ul/li/a[text()="Kasese solgs trial"]',
            'xpath',
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="139-DMCP-3-FRW-5"]',
...
'//img[@id="k-means-plot-139-139-DMCP-3-FRW-5-genotype-k-4-gp-1-sp-15"]',
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="trial2 NaCRRI"]',
            'xpath',
...
#    #
        ...
        sleep(2);
        $d->find_element_ok( 'population_search_entry', 'id',
            'population search form' )->send_keys('nacrri');
        sleep(5);
        $d->find_element_ok( 'search_training_pop', 'id',
            'search for training pop' )->click();
        sleep(1);
...
'//table[@id="list_type_selection_pops_table"]//*[contains(text(), "Predict")]',
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="Training population 2804608595"]',
            'xpath',
            'select list sel pop'
        )->click();
        sleep(5);
...
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="Training population 2804608595"]',
        ...
        $d->driver->execute_script(
            ...
            $clustering );
        sleep(5);
        $d->find_element_ok( 'cluster_dropdown', 'class', 'click cluster pops' )
          ->click();
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="Training population 2804608595"]',
...
'//img[@id="k-means-plot-2804608595-traits-1971973596-genotype-k-4-gp-1"]',
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="si_dropdown"]/dd/ul/li/a[text()="Training population 2804608595"]',
            'xpath',
            'select combo pop'
        )->click();
        sleep(3);
        ...
        sleep(3);
        $d->find_element_ok(
'//dl[@class="cluster_dropdown"]/dd/ul/li/a[text()="2804608595-DMCP-3-FRW-5"]',
            'xpath', 'si'
        )->click();
        sleep(5);
        $d->find_element_ok( '//*[starts-with(@id, "cluster_type_select")]',
...
'//div[@id="list_type_selection_pops_list"]/select[@id="list_type_selection_pops_list_select"]/option[text()="'
        ...
        $d->driver->execute_script(
            ...
            $clustering );
        sleep(5);
        $d->find_element_ok( 'cluster_dropdown', 'class',
