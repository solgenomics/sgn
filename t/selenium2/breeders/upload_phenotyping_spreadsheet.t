...
$t->while_logged_in_as("submitter", sub { 
    ...
    my $upload_input = $t->find_element_ok("upload_phenotype_file_input", "id", "find file input");
    ...
    $t->find_element_ok("upload_phenotype_submit_verify", "id", "submit spreadsheet file for verification")->click();
    ...
    $t->find_element_ok("upload_phenotype_submit_store", "id", "submit spreadsheet file for storage")->click();
