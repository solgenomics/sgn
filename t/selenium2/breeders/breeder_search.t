...
$t->while_logged_in_as("submitter", sub {
    ...
    $t->find_element_ok("select1", "id", "retrieve trials")->send_keys('trials');

    sleep(2);

    $t->find_element_ok("c1_data", "id", "select specific trial")->send_keys('trial2 NaCRRI');

    $t->find_element_ok("c1_select_all", "id", "select all trials")->click();
    ...
    $t->find_element_ok("c2_data", "id", "select specific breeding_program")->send_keys('test');
    ...
    $t->find_element_ok("c3_data", "id", "select specific genotyping protocol")->send_keys('GBS ApeKI genotyping v4');
